            ...
            ?>
                ...
                ?>
                    <div class="col-12 col-lg-8">
                        ...
                        <?php include "cartcalculationProcess.php" ?>
                        <?php
                        $cart_rs = Database::search("SELECT * FROM `cart` WHERE `user_email`='" . $email . "'");
                        $cart_num = $cart_rs->num_rows;
                        ...
                        <div class="row product-wishlist">
                            ...
                            <div class="col-12" style="display: flex; flex-direction: row; justify-content: center;">
                                <div class="col-6 text-start mb-3">
                                    <span class="fs-6 f1" style="color: #0073e6; margin-right: 90px; font-size: 16px;">Cost for <?php echo $cart_num; ?> Product</span>

                                </div>

                                <div class="col-6 mb-3 text-end">
                                    <span class="fs-5 f1" style="color: black; align-items:end; font-size: 16px;">Rs. <?php echo $total*1/2; ?> .00</span>
                                </div>
                            </div>
                            <?php
