...
<head>
    ...
    <title> Chanaka Electronics Store </title>
...
<body class="body1">
    ...
    <div class="container-fluid vh-100 d-flex justify-content-center align-content-center" style="background-color: rgba(0, 0, 0, 0.10);">
            ...
            <div class="col-10 col-lg-4" id="signUpBox">
                <div class="row g-2 d-flex justify-content-center  mx-2 rounded-4" style="background-color: rgba(43, 45, 66, 0.93);">
                    ...
                    <div class="col-10  d-grid mt-2">
                        <button class="btn f2" style="background-color: rgba(43, 45, 66, 0.68); box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) inset;" onclick="signUp();">Sign Up</button>
                    </div>
            ...
            <div class="col-10 col-lg-4 d-none" id="signInBox">
                <div class="row g-2 d-flex justify-content-center  mx-2 rounded-4" style="background-color: rgba(43, 45, 66, 0.93);">
                    ...
                    <div class="col-5 text-end">
                        <a href="#" class="link-primary f1" onclick="forgotPassword();">Forgot Password?</a>
                    </div>


                    <div class="col-10 d-grid mt-2">
                        <button class="btn f2" style="background-color: #0073e6; color: white; box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) inset;" onclick="signIn();">Sign In</button>
                    </div>
                    <div class="col-10  d-grid mt-2 mb-4">
        ...
        <div class="col-12 fixed-bottom d-none d-lg-block">
            <p class="text-center">&copy; 2024 chanakaElectronics.com || All Right Reserved</p>
        </div>
