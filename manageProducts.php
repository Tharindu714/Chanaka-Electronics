                    ...
                    ?>
                        <div class="row mx-2 my-3 rounded-3 " style="background-color: #2b2d42; box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) inset;">
                            ...
                            <div class="col-lg-1">
                                ...
                                ?>
                                    <button id="pb<?php echo $selected_data['id']; ?>" class="rounded-3 text-white my-2" style="background-color: #0073e6; border: none; width: 75px; box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) inset;" onclick="blockProduct('<?php echo $selected_data['id']; ?>');">Block</button>
                                <?php
                                } else {
                                ?>
