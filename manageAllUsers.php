          ...
          ?>
            ...
            <div class="row mx-2 my-3 rounded-3 " style="background-color: #2b2d42; box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) inset;">
              ...
              <div class="col-lg-1">
                ...
                ?>
                  <button id="UB<?php echo $selected_data['email']; ?>" class="rounded-3 text-white my-2" style="background-color: #0073e6; border: none; width: 75px; box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) inset;" onclick="blockUser('<?php echo $selected_data['email']; ?>');">Block</button>
                <?php
                } else {
                ?>
        ...
        <div class="offset-2 offset-lg-3 col-8 col-lg-6 text-center mt-3">
          <nav aria-label="Page navigation example">
            <ul class="pagination pagination-lg justify-content-center">
              <li class="page-item">
                <a class="page-link  fw-bold" style="color: #0073e6;" href="<?php if ($pageno <= 1) {
                                                                              echo ("#");
                                                                            } else {
                                                                              echo "?page=" . ($pageno - 1);
                                                                            } ?>" aria-label="Previous">
              ...
              ?>
                  <li class="page-item active">
                    <a class="page-link  fw-bold" style="background-color: #0073e6; border: none;" href="<?php echo "?page=" . ($x) ?>"><?php echo $x; ?></a>
                  </li>
                <?php
                } else {
                ?>
              ...
              <li class="page-item">
                <a class="page-link  fw-bold" style="color: #0073e6;" href="<?php if ($pageno >= $number_of_pages) {
                                                                              echo ("#");
                                                                            } else {
                                                                              echo "?page=" . ($pageno + 1);
                                                                            } ?>" aria-label="Next">
