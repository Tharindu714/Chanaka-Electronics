...
-- Dumping data for table ceonline.category: ~4 rows (approximately)
...
REPLACE INTO `wishlist` (`id`, `product_id`, `user_email`) VALUES
	(37, 104, 'tharinduchanaka6@gmail.com');
