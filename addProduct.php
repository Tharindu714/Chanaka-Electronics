        ...
        <div class="col-12">
          <div class="row d-flex justify-content-center mt-3 add-product-details">
            <div class="col-lg-5 col-md-5 col-sm-10 mx-2 my-2">
              ...
              <div class="col-12 d-flex justify-content-center">
                <label class="text-white my-2">Select Supplier</label>
              </div>
              <div class="col-12 d-flex justify-content-center">
                <select class="form-select text-center text-white rounded-4" id="supplier" style="height: 40px; background-color: #2b2d42; border: 2px solid white; box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) inset; font-size: medium;">
                  <?php
                  $sup_rs = Database::search("SELECT * FROM `supplier`");
                  $sup_num = $sup_rs->num_rows;

                  for ($x = 0; $x < $sup_num; $x++) {
                    $sup_data = $sup_rs->fetch_assoc();
                  ?>
                    <option value="<?php echo $sup_data["id"]; ?>">
                      <?php echo $sup_data["name"]; ?>
                    </option>
                  <?php
                  }
                  ?>
            ...
            <div class="col-lg-5 col-md-5 col-sm-10 mx-2 my-2 add-product-detail-box-2" style="border-left:2px solid #0073e6;">
              ...
              <div class="col-12 d-flex justify-content-center">
                <label class="text-white my-2">Delivery Cost - Bandarawela</label>
              </div>
              <div class="col-12 d-flex justify-content-center">
                <span class="input-group-text rounded-4 text-white" style="outline: none; height: 40px; background-color: #2b2d42; border: 2px solid white; box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) inset;">Rs.</span>
